import { RESOURCE_CLASS, RESOURCE_CLASS_ALIAS } from '@/app/constants/app-texts';
  ...
  return (
    <div className="order-scope-sidebar">
      <span
        ...
        onClick={() => handleActivate(RESOURCE_CLASS_ALIAS.WEB, RESOURCE_CLASS.WEB)}>
        Web
      </span>
      <span
        ...
        onClick={() => handleActivate(RESOURCE_CLASS_ALIAS.MOBILE, RESOURCE_CLASS.MOBILE)}>
        Mobile
      </span>
      <span
        ...
        onClick={() => handleActivate(RESOURCE_CLASS_ALIAS.CLOUD, RESOURCE_CLASS.CLOUD)}>
        Cloud
      </span>
      <span
        ...
        onClick={() => handleActivate(RESOURCE_CLASS_ALIAS.SOCIAL, RESOURCE_CLASS.SOCIAL)}>
        Social
      </span>
      <span
        ...
        onClick={() => handleActivate(RESOURCE_CLASS_ALIAS.SOURCE, RESOURCE_CLASS.SOURCE)}>
        Source
      </span>
      <span
