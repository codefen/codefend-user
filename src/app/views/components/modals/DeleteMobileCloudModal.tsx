...
export const DeleteMobileCloudModal: FC<DeleteMobileCloudModalProps> = ({ onDone }) => {
  const { isOpen, setIsOpen, isMobileType, appName, id, handleDelete } = useRemoveAppStore(
  ...
  return (
    <ModalTitleWrapper isActive={isOpen} close={closeModal} headerTitle="Delete mobile app">
      <div
