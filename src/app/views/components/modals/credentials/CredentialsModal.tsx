      ...
      <ModalWrapper action={handleClose} type="credential-modal med-w">
        <div className="card">
          <div className="header">
            ...
            <Show when={type !== RESOURCE_CLASS.CLOUD && type !== RESOURCE_CLASS.MOBILE}>
              <div className="actions">
                <div onClick={() => setActivePage(CredentialPage.ADD)}>Add</div>
                <div onClick={() => setActivePage(CredentialPage.VIEW)}>View</div>
              </div>
            </Show>
          </div>
          <div className="content">
            ...
            <Show when={activePage == CredentialPage.VIEW}>
              <ViewCredentials close={handleClose} resourceId={resourceId} type={type} />
            </Show>
          </div>
        </div>
      </ModalWrapper>
