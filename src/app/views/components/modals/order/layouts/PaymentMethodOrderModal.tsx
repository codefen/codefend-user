					...
					<div
						...
						<label htmlFor="bank-transfer" className="order-snapshot">
							...
							<span className="one-pentest">
								Small team allocation. Codefend will allocate a team of
								2 hackers to accomplish this task within 4 weeks.
					...
					<div
						...
						<label htmlFor="card" className="order-snapshot">
							...
							<span className="one-pentest">
								...
								security assessment on the selected scope, one report,
								no subscription.
							</span>
						</label>
					</div>
