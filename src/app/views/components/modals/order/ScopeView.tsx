		...
		<div>
			...
			<div className="scope-content">
				<div className="option show-border">
					...
					/>
					<label htmlFor="mobile-resources" className="order-snapshot">
						<div className="top">
							<p> I want to analyze all my team mobile resources</p>
							<span className="codefend-color order-dash-space">
								{' '}
								- 6 resources:
							</span>
						</div>
				...
				<div className="option bottom-border">
					...
					/>
					<label htmlFor="team-resources" className="order-snapshot">
						<div className="top">
