...
export const SourceScope: FC<ResourceScope<any>> = ({ resources, isLoading }) => {
  return (
    <ol className="source-code-scope">
      <li>
        <span className="source-scope-item">ID:</span>{' '}
        <span className="source-scope-item item-value">{!isLoading ? resources.id : '...'}</span>
      </li>
      <li>
        <span className="source-scope-item">Name:</span>{' '}
        <span className="source-scope-item item-value">{!isLoading ? resources.name : '...'}</span>
      </li>
      <li>
