      ...
      <Show when={Boolean(providers.length) && openModel}>
        <>
          <div className="step-header">
            <h3>
              <b>Select the provider you want to transfer the order to</b>
            </h3>
          </div>
                ...
                <div className="order-snapshot">
                  <div>
                    <p>
                      ...
                      <span className="codefend-text-red">@{provider.username}</span>
                    </p>
                  </div>
                  <span className="one-pentest">{provider.headline}</span>
                  <span className="one-pentest leading-text">
                    <span className="codefend-text-red">Match:</span> specialized in{' '}
                    <b>web resources.</b>
                  </span>
                </div>
              </div>
