...
export const WelcomeGuide: FC<WelcomeGuideProps> = ({ defaultOpenValue, closeGuide }) => {
  ...
  return (
    <div className="guide-container">
      ...
      <Show when={currentStep === WelcomeSteps.DASHBOARD && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
      ...
      <Show when={currentStep === WelcomeSteps.WEB && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
      ...
      <Show when={currentStep === WelcomeSteps.MOBILE && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
      ...
      <Show when={currentStep === WelcomeSteps.NET && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
      ...
      <Show when={currentStep === WelcomeSteps.CLOUD && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
      ...
      <Show when={currentStep === WelcomeSteps.SOURCE && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
      ...
      <Show when={currentStep === WelcomeSteps.SOCIAL && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
      ...
      <Show when={currentStep === WelcomeSteps.ISSUES && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
      ...
      <Show when={currentStep === WelcomeSteps.SUPPORT && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
      ...
      <Show when={currentStep === WelcomeSteps.PREFERENCES && (isAdmin() || isNormalUser())}>
        <HelperBox
          close={closeGuide}
          next={closeGuide}
