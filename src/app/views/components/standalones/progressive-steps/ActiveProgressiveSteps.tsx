...
export const ActiveProgressiveSteps: FC<ActiveProgressiveStepsProps> = ({ orderStepActive }) => {
  ...
  return (
    <div className="steps">
      ...
      <StepItem text="4" styles={currentOrCompleted(orderStepActive, OrderSection.ENVIRONMENT)} />
      <StepItem
        text="5"
        styles={currentOrCompleted(orderStepActive, OrderSection.ADDITIONAL_INFO)}
      />
      <StepItem text="6" styles={currentOrCompleted(orderStepActive, OrderSection.PAYMENT)} />
      <StepItem
        text="7"
