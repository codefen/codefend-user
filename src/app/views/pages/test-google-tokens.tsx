...
const TestGoogleTokens: React.FC = () => {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ marginTop: '30px', padding: '15px', backgroundColor: '#e7f3ff', borderRadius: '5px' }}>
        <h3>📋 Instrucciones:</h3>
        <ol>
          <li>Ve a <a href="https://developers.google.com/oauthplayground/" target="_blank" rel="noopener noreferrer">Google OAuth Playground</a></li>
          <li>Configura tu Client ID: <code>452661025370-q6rirfe3gfik0spkd65369b8q3hposp5.apps.googleusercontent.com</code></li>
          <li>Selecciona "People API v1" y scope: <code>https://www.googleapis.com/auth/contacts.readonly</code></li>
