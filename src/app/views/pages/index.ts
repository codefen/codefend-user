...
export const MobileApplication = lazy(
  () => import('./panel/layouts/mobile/MobileApplicationPanel.tsx')
);
...
export const SocialEngineeringPanel = lazy(
  () => import('./panel/layouts/social/SocialEngineeringPanel.tsx')
);
export const SupportPanel = lazy(() => import('./panel/layouts/support/SupportPanel.tsx'));
export const PreferencePanel = lazy(
  () => import('./panel/layouts/preferences/PreferencePanel.tsx')
);
...
export const ResellerUsersLayout = lazy(
  () => import('./panel/layouts/reseller/layouts/ResellerUsersLayout.tsx')
);
export const ResellerCompaniesLayout = lazy(
  () => import('./panel/layouts/reseller/layouts/ResellerCompaniesLayout.tsx')
);
export const ResellerOrdersLayout = lazy(
  () => import('./panel/layouts/reseller/layouts/ResellerOrdersLayout.tsx')
);

export const ProviderPage = lazy(() => import('./panel/layouts/providers/ProviderPanel.tsx'));
export const ProfileProviderLayout = lazy(
  () => import('./panel/layouts/providers/layouts/profile-provider/ProfileProviderLayout.tsx')
);
export const OrdersReviewProviders = lazy(
  () => import('./panel/layouts/providers/layouts/orders-provider/OrdersProviderLayout.tsx')
);
