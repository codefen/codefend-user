...
export const IssueReport: FC<Props> = props => {
  const filterIssues = useMemo(() => {
    return Object.keys(props.issuesClasses)
      ...
      .filter((item: any) => props.issuesClasses[item as keyof typeof props.issuesClasses] != '0');
  }, [props.issuesClasses]);
  ...
  return (
    <>
      <div className="card filtered">
        <SimpleSection header="FILTER AND GENERATE REPORT" icon={<ChartIcon />}>
              ...
              <Fragment key={filterKeys[i]}>
                <div className="filter">
                  <div className="check">
                    <label className="label">
                      <input
                        type="checkbox"
                        disabled={
                          props.issuesClasses[issueClass as keyof typeof props.issuesClasses] == '0'
                        }
                  ...
                  <div className="value">
                    ...
                    <span>
                      {props.issuesClasses[issueClass as keyof typeof props.issuesClasses]}
                    </span>
                  </div>
                </div>
              </Fragment>
