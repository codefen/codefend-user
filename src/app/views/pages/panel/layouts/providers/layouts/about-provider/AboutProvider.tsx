	...
	return (
		<div className="provider-about">
			...
			<div className="about-provider">
				...
				<p>
					On the Myers-Briggs type indicator after a few years of marrlage
					and a few months of being a parent it seems that i tend towards
					ENFP, was ESFP before. I consider myself{' '}
					<b>a full-time learner in technical and social subjects.</b>
				</p>
				<p>
					I am an{' '}
					<b>information security researcher with an extensive career</b>{' '}
					of more than 10 years. I have public recognitions for reporting
					vulnerabilities to some major organizations like CERN, US
					Department of State.{' '}
					<b>US Department of Health and Human Services</b> and a few
					others from international private responsible disclosure programs
					and bug bounty.
				</p>
				...
				<ul>
					...
					<li>
						<span>U.S Department of Health and Human Services(HHS)</span>
					</li>
					<li>
