	...
	return (
		<EndpointAppProvider>
			<main
				className={`${
					showScreen ? 'actived' : ''
				} flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-10 ml-16 mt-4`}>
								...
								<div
									...
									<div className="flex items-center mr-auto p-4">
										...
										<div className="flex flex-col ml-3 min-w-0">
											<div className="text-xl font-black leading-none text-gray-700">
												{scan.device_os_name}
											</div>
											<p className="text-base text-gray-500 leading-none mt-1 truncate text-red-400">
									...
									<div className="p-2 pl-4 flex text-sm text-gray-600 font-bold border-y">
										...
										<p className="cursor-default text-red-400 font-bold ml-1">
											{scan.apps_found}
										</p>
									</div>
									<div className="flex items-center p-4 text-sm text-gray-800">
										<button
											className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium cursor-pointer border bg-white text-red-400 rounded hover:bg-red-100 border-red-400"
											onClick={() => {
