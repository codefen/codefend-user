                ...
                <>
					...
					<div className="flex flex-col p-4 m-4 ml-0">
						...
						<div className="flex items-center justify-between ">
							<div className="flex p-2 items-center w-1/2 border-solid border-b border-r border-stone-200">
								<div className="flex flex-col ml-3 min-w-0">
									<p className="text-sm font-bold text-gray-400 leading-none mt-1 truncate">{endpoints.device_ip_i} - {endpoints.device_ip_e}</p>
								</div>
							</div>
					...
					<div className="overflow-auto max-h-[65vh]">
						<Show when={endpoints.scanned == 0}>
							<div className="border-stone-200 flex flex-col p-4 m-4 mt-0 mb-8 border-solid border hover:bg-stone-50 duration-300 ease-in-out">
								<div className="flex justify-between">
									...
									<div className="flex items-center mr-auto">
										<div className="flex flex-col ml-3 min-w-0">
											<div className="text-sm leading-none text-gray-500 flex">the scan is currently in process</div>
										</div>
									</div>
								</div>
							</div>
...

						{
							endpointApps.map(updateEndpointVersion).sort(sortEndpoints).map((endpoint: any) => (
								...
								>
									...
									<div className="flex items-center mr-auto">
										<div className="inline-flex w-18 h-18">
										<span className="w-12 h-12 inline-flex rounded-md border-solid border border-stone-200 opacity-75">
											<Show when={endpoint.icon_url}>
												<img src={endpoint.icon_url} alt="" className=" relative w-12 h-12 object-cover rounded-md">
												</img>
											</Show>
										</span>
										</div>
