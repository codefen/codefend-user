...
export const EndpointAppProvider: React.FC<EndpointAppProviderProps> = ({ children }) => {
    ...
    return (
        <EndpointAppContext.Provider value={{ endpointAppStore, setEndpointAppStore, isModalOpen, openModal, closeModal }}>
            {children}
