...
export const TeamMembersPage = () => {
  ...
  const { isLoading, data, company } = useDashboard();
              ...
              <div className="company-info-content">
                <div className="company-info-item">
                  <span className="single-line">
                    <strong>Business ID:</strong> {data?.company?.id}
                  </span>
                </div>

                <div className="company-info-item">
                  <span className="single-line">
                    <strong>Business name:</strong> {data?.company?.name}
                  </span>
                </div>
                ...
                <div className="company-info-item">
                  <span className="single-line area-line">
                    <strong>Area:</strong>{' '}
                    {data?.company?.pais_code && (
                      <span
                        className={`flag flag-${normalizeCountryCode(data?.company?.pais_code)}`}></span>
                    )}
                ...
                <div className="company-info-item">
                  <span className="single-line">
                    <strong>Web:</strong> {data?.company?.web || '-'}
                  </span>
                </div>

                <div className="company-info-item">
                  <span className="single-line">
                    <strong>Business size:</strong> {formatBusinessSize(data?.company?.size)}
                  </span>
                </div>
                ...
                <div className="company-info-item">
                  <span className="single-line">
                    <strong>Owner:</strong>{' '}
                    {[data?.company?.owner_fname, data?.company?.owner_lname]
                      .filter(Boolean)
                      .join(' ')}
                  </span>
                </div>
                ...
                <div className="company-info-item">
                  <span className="single-line">
                    <strong>Owner email:</strong> {data?.company?.owner_email}
                  </span>
                </div>

                <div className="company-info-item">
                  <span className="single-line">
                    <strong>Current plan:</strong> {data?.company?.plan}
                  </span>
                </div>
              </div>
            </div>
