    ...
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '30px', padding: '20px', border: '1px solid #ddd', borderRadius: '8px' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <p>El popup está siendo bloqueado por el navegador. Usa Google OAuth Playground para obtener un access token válido:</p>
          ...
          <div style={{ 
            ...
            <ol style={{ margin: '0', paddingLeft: '20px' }}>
              ...
              <li>En la página que se abre, haz clic en el ícono de configuración (⚙️) en la esquina superior derecha</li>
              <li>Marca la casilla "Use your own OAuth credentials"</li>
              <li>Ingresa tu Client ID: <code>452661025370-q6rirfe3gfik0spkd65369b8q3hposp5.apps.googleusercontent.com</code></li>
              <li>Haz clic en "Close"</li>
              <li>En la lista de APIs, busca y selecciona: <code>https://www.googleapis.com/auth/contacts.readonly</code></li>
          ...
          <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
            {contacts.map((contact, index) => (
              <div key={index} style={{ 
                ...
                <strong>Emails:</strong> {contact.emails?.join(', ') || 'Sin emails'}<br/>
                <strong>Teléfonos:</strong> {contact.phones?.join(', ') || 'Sin teléfonos'}<br/>
      ...
      <div style={{ 
        ...
        <p><strong>Client ID:</strong> 452661025370-q6rirfe3gfik0spkd65369b8q3hposp5.apps.googleusercontent.com</p>
        <p><strong>Scope necesario:</strong> https://www.googleapis.com/auth/contacts.readonly</p>
        <p><strong>API endpoint:</strong> https://people.googleapis.com/v1/people/me/connections</p>
        <p><strong>Problema actual:</strong> El popup está siendo bloqueado por políticas de seguridad del navegador</p>
      </div>
    </div>
  );
};
